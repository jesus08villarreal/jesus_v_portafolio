export const translations = {
  en: {
    ...
    hero: {
      ...
      subtitle: 'Full-stack developer with experience in front-end and back-end technologies, specialized in creating scalable and efficient web solutions.',
    },
    about: {
      title: 'About Me',
  ...
  es: {
    ...
    hero: {
      ...
      subtitle: 'Desarrollador Full-stack con experiencia en tecnologías front-end y back-end, especializado en crear soluciones web escalables y eficientes.',
    },
    about: {
      title: 'Sobre Mí',
